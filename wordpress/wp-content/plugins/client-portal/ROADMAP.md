...
- [ ] Expand audit logging to include REST mutations, document downloads, and administrative actions.
...
- [ ] Build guided setup wizards that walk admins through role assignment, branding, and integration toggles.
