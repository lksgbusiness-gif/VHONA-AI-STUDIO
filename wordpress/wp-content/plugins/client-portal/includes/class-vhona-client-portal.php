...
class Plugin
{
    ...
    public function render_settings_page()
    {
        ...
        $settings = $this->get_settings();
        $export_url = wp_nonce_url(admin_url('admin-post.php?action=vhona_client_portal_export_logs'), 'vhona_export_logs');
        $state = $this->get_onboarding_state();
        $steps = $this->get_onboarding_steps();
        ...
        <div class="wrap">
            ...
            <p><a class="button" href="<?php echo esc_url($export_url); ?>"><?php esc_html_e('Export CSV', 'vhona-client-portal'); ?></a></p>
            ...
            <table class="widefat">
                ...
                <tbody>
                    <?php if (empty($entries)) : ?>
                        <tr><td colspan="3"><?php esc_html_e('No activity recorded yet.', 'vhona-client-portal'); ?></td></tr>
                    <?php else : ?>
                ...
                <div class="tablenav">
                    <div class="tablenav-pages">
                        ...
                        <span class="pagination-links">
                            <?php
                            $base_args = ['page' => 'vhona-client-portal'];
                            if ($log_type) {
                                $base_args['log_type'] = $log_type;
                            }
    ...
    public function handle_export_logs()
    {
        ...
        $this->log_activity('logs_exported', __('Activity log exported', 'vhona-client-portal'));
        $csv = $this->activity_logger->to_csv();
        nocache_headers();
